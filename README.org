...
There are couple of choice for running the code for this class
 This is the most straight forward option and supports lot fo scientific python including tensorflow and keras for deep learning.
- Google colab.  https://colab.research.google.com/notebooks/welcome.ipynb

- or Please install [[https://www.anaconda.com/download/][Anaconda for Python 3.6 version data science platform. ]
...
|-----------------------------------------------------------------------+---------------|
| Final exam comprehensive,  ??? August, in class close books and notes |           30% |
|-----------------------------------------------------------------------+---------------|
| Final Project presentation and report, ??? August 11.59 p.m           |     (5 + 10)% |
|                                                                       |               |
|-----------------------------------------------------------------------+---------------|
